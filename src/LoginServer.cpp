...
TEST_CASE("Login Server") {
    ...
    const auto expected = R"(<form action="/login" method="post"><input type="text" m_id="username" name="username"><input type="password" m_id="password" name="password"><input type="submit" m_id="submit" name="submit"></form>)";
